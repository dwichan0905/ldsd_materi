...
;http://www.hpinfotech.com
;
;Project : Lamu Lalu Lintas
;Version : 1.2
;Date    : 6/24/2019
;Author  : Rizky Arsyansyah Rinjani & Ilham Alif Ramadhan
;Company : STMIK AMIKOM PURWOKERTO
;Comments: TI 18 S (18.11.0153 & 18.11.0000)
;
;
;Chip type               : ATmega16
;Program type            : Application
...
;
;int merah   = 4; // desimal, biner : 0b00000100
;int kuning  = 2; // desimal  biner : 0b00000010
;int hijau   = 1; // desimal  biner : 0b00000001
;
;void main(void)
; 0000 0022 {
...
; 0000 0028 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(7)
	OUT  0x1A,R30
...
; 0000 002D // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 002E DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (1<<DDB2) | (1<<DDB1) | (1<<DDB0);
	LDI  R30,LOW(7)
	OUT  0x17,R30
; 0000 002F // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=0 Bit1=0 Bit0=0
; 0000 0030 PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	LDI  R30,LOW(0)
	OUT  0x18,R30
; 0000 0031 
; 0000 0032 // Port C initialization
; 0000 0033 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=In Bit2=Out Bit1=Out Bit0=Out
; 0000 0034 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(7)
	OUT  0x14,R30
; 0000 0035 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=0 Bit1=0 Bit0=0
...
; 0000 003A DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(7)
	OUT  0x11,R30
; 0000 003B // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=0 Bit1=0 Bit0=0
...
_0x3:
; 0000 008C {
; 0000 008D       PORTA = hijau;
	OUT  0x1B,R8
; 0000 008E       PORTB = merah;
	OUT  0x18,R4
; 0000 008F       PORTC = merah;
	OUT  0x15,R4
; 0000 0090       PORTD = merah;
	OUT  0x12,R4
; 0000 0091 
; 0000 0092       delay_ms(200);
	RCALL SUBOPT_0x0
; 0000 0093       PORTA = kuning;
	OUT  0x1B,R6
; 0000 0094       delay_ms(50);
	RCALL SUBOPT_0x1
; 0000 0095       PORTA = merah;
	OUT  0x1B,R4
; 0000 0096       delay_ms(20);
	RCALL SUBOPT_0x2
; 0000 0097 
; 0000 0098       PORTB = hijau;
	OUT  0x18,R8
; 0000 0099       delay_ms(200);
	RCALL SUBOPT_0x0
; 0000 009A       PORTB = kuning;
	OUT  0x18,R6
; 0000 009B       delay_ms(50);
	RCALL SUBOPT_0x1
; 0000 009C       PORTB = merah;
	OUT  0x18,R4
; 0000 009D       delay_ms(20);
	RCALL SUBOPT_0x2
; 0000 009E 
; 0000 009F       PORTC = hijau;
	OUT  0x15,R8
; 0000 00A0       delay_ms(200);
	RCALL SUBOPT_0x0
; 0000 00A1       PORTC = kuning;
	OUT  0x15,R6
; 0000 00A2       delay_ms(50);
	RCALL SUBOPT_0x1
; 0000 00A3       PORTC = merah;
	OUT  0x15,R4
; 0000 00A4       delay_ms(20);
	RCALL SUBOPT_0x2
; 0000 00A5 
; 0000 00A6       PORTD = hijau;
	OUT  0x12,R8
; 0000 00A7       delay_ms(200);
	RCALL SUBOPT_0x0
; 0000 00A8       PORTD = kuning;
	OUT  0x12,R6
