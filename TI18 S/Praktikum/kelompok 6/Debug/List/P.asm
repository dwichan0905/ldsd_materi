...
; 0000 0089           PORTA = hijau;
	OUT  0x1B,R8
; 0000 008A           PORTB = merah;
	OUT  0x18,R4
; 0000 008B           PORTC = merah;
	OUT  0x15,R4
; 0000 008C           PORTD = merah;
	OUT  0x12,R4
; 0000 008D 
; 0000 008E           delay_ms(200);
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 008F           PORTA = kuning;
	OUT  0x1B,R6
; 0000 0090           delay_ms(50);
	LDI  R26,LOW(50)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0091           PORTA = merah;
	OUT  0x1B,R4
; 0000 0092           delay_ms(20);
	...
	RCALL _delay_ms
; 0000 0093 
; 0000 0094           PORTB = hijau;
	OUT  0x18,R8
; 0000 0095           delay_ms(200);
	LDI  R26,LOW(200)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0096           PORTB = kuning;
	OUT  0x18,R6
; 0000 0097           delay_ms(50);
	LDI  R26,LOW(50)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0098           PORTB = merah;
	OUT  0x18,R4
; 0000 0099           delay_ms(20);
	...
	RCALL _delay_ms
; 0000 009A 
; 0000 009B           PORTC = hijau;
	OUT  0x15,R8
; 0000 009C           delay_ms(200);
	LDI  R26,LOW(200)
	LDI  R27,0
	RCALL _delay_ms
; 0000 009D           PORTC = kuning;
	OUT  0x15,R6
; 0000 009E           delay_ms(50);
	LDI  R26,LOW(50)
	LDI  R27,0
	RCALL _delay_ms
; 0000 009F           PORTC = merah;
	OUT  0x15,R4
; 0000 00A0           delay_ms(20);
	...
	RCALL _delay_ms
; 0000 00A1 
; 0000 00A2           PORTD = hijau;
	OUT  0x12,R8
; 0000 00A3           delay_ms(200);
	LDI  R26,LOW(200)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00A4           PORTD = kuning;
	OUT  0x12,R6
