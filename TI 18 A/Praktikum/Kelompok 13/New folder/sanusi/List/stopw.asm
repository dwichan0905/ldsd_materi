...
_0x0:
	.DB  0x73,0x74,0x6F,0x70,0x77,0x0,0x25,0x69
	.DB  0x25,0x69,0x20,0x3A,0x20,0x25,0x69,0x25
	.DB  0x69,0x20,0x3A,0x20,0x25,0x69,0x25,0x69
	.DB  0x20,0x0
_0x2020060:
	.DB  0x1
_0x2020000:
...
; 0000 009C       sprintf(tampung,"%i%i : %i%i : %i%i ",m2,m1,s2,s1,ms2,ms1 ); //simpan data integer kearray tampung(16)
	LDI  R30,LOW(_tampung)
	LDI  R31,HIGH(_tampung)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,6
	ST   -Y,R31
...
; 0000 009E       lcd_puts(tampung); //menampilkan array tampung bertype char
	LDI  R26,LOW(_tampung)
	LDI  R27,HIGH(_tampung)
	CALL _lcd_puts
; 0000 009F      }
	RJMP _0x3
; 0000 00A0 }
