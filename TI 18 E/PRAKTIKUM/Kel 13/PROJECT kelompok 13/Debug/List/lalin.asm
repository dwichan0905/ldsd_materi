...
; 0000 0023 DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 0024 // State: Bit7=1 Bit6=1 Bit5=1 Bit4=1 Bit3=1 Bit2=1 Bit1=1 Bit0=1
; 0000 0025 PORTA=(1<<PORTA7) | (1<<PORTA6) | (1<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (1<<PORTA1) | (1<<PORTA0);
	OUT  0x1B,R30
; 0000 0026 
...
; 0000 0089       PORTA = 0b01001001;  //9
	LDI  R30,LOW(73)
	OUT  0x1B,R30
; 0000 008A       PORTD = 0b01001001;  //9
	OUT  0x12,R30
; 0000 008B       PORTB = 0b00011100;  //3
	LDI  R30,LOW(28)
	OUT  0x18,R30
; 0000 008C       PORTC = 0b00010001;  //4
	LDI  R30,LOW(17)
	RCALL SUBOPT_0x0
; 0000 008D       delay_ms(100);
; 0000 008E       PORTA = 0b00001001;  //8
	LDI  R30,LOW(9)
	OUT  0x1B,R30
; 0000 008F       PORTD = 0b01000001;  //8
	LDI  R30,LOW(65)
	OUT  0x12,R30
; 0000 0090       PORTB = 0b00010100;  //2
	LDI  R30,LOW(20)
	OUT  0x18,R30
; 0000 0091       PORTC = 0b01100001;  //3
	LDI  R30,LOW(97)
	RCALL SUBOPT_0x0
; 0000 0092       delay_ms(100);
; 0000 0093       PORTA = 0b01110001;  //7
	LDI  R30,LOW(113)
	OUT  0x1B,R30
; 0000 0094       PORTD = 0b00111001;  //7
	LDI  R30,LOW(57)
	OUT  0x12,R30
; 0000 0095       PORTB = 0b00001100;  //1
	LDI  R30,LOW(12)
	OUT  0x18,R30
; 0000 0096       PORTC = 0b00100001;  //2
	LDI  R30,LOW(33)
	RCALL SUBOPT_0x0
; 0000 0097       delay_ms(100);
; 0000 0098       PORTA = 0b00110001;  //6
	LDI  R30,LOW(49)
	OUT  0x1B,R30
; 0000 0099       PORTD = 0b00110001;  //6
	OUT  0x12,R30
; 0000 009A       PORTB = 0b00000100;  //0
	LDI  R30,LOW(4)
	OUT  0x18,R30
; 0000 009B       PORTC = 0b01000011;  //1
	LDI  R30,LOW(67)
	RCALL SUBOPT_0x0
; 0000 009C       delay_ms(100);
; 0000 009D       PORTA = 0b01010001;  //5
	LDI  R30,LOW(81)
	OUT  0x1B,R30
; 0000 009E       PORTD = 0b00101001;  //5
	LDI  R30,LOW(41)
	OUT  0x12,R30
; 0000 009F       PORTB = 0b00000010;  //k
	LDI  R30,LOW(2)
	OUT  0x18,R30
; 0000 00A0       PORTC = 0b00000011;  //0
	LDI  R30,LOW(3)
	RCALL SUBOPT_0x0
; 0000 00A1       delay_ms(100);
; 0000 00A2       PORTA = 0b00010001;  //4
	LDI  R30,LOW(17)
	OUT  0x1B,R30
; 0000 00A3       PORTD = 0b00100001;  //4
	LDI  R30,LOW(33)
	OUT  0x12,R30
; 0000 00A4       PORTB = 0b01001001;  //9
	LDI  R30,LOW(73)
	OUT  0x18,R30
; 0000 00A5       PORTC = 0b01100100;  //3
	LDI  R30,LOW(100)
	RCALL SUBOPT_0x0
; 0000 00A6       delay_ms(100);
; 0000 00A7       PORTA = 0b01100001;  //3
	LDI  R30,LOW(97)
	OUT  0x1B,R30
; 0000 00A8       PORTD = 0b00011001;  //3
	LDI  R30,LOW(25)
	OUT  0x12,R30
; 0000 00A9       PORTB = 0b01000001;  //8
	LDI  R30,LOW(65)
	OUT  0x18,R30
; 0000 00AA       PORTC = 0b00100100;  //2
	LDI  R30,LOW(36)
	RCALL SUBOPT_0x0
; 0000 00AB       delay_ms(100);
; 0000 00AC       PORTA = 0b00100001;  //2
	LDI  R30,LOW(33)
	OUT  0x1B,R30
; 0000 00AD       PORTD = 0b00010001;  //2
	LDI  R30,LOW(17)
	OUT  0x12,R30
; 0000 00AE       PORTB = 0b00111001;  //7
	LDI  R30,LOW(57)
	OUT  0x18,R30
; 0000 00AF       PORTC = 0b01000100;  //1
	LDI  R30,LOW(68)
	RCALL SUBOPT_0x0
; 0000 00B0       delay_ms(100);
; 0000 00B1       PORTA = 0b01000011;  //1
	LDI  R30,LOW(67)
	OUT  0x1B,R30
; 0000 00B2       PORTD = 0b00001011;  //1
	LDI  R30,LOW(11)
	OUT  0x12,R30
; 0000 00B3       PORTB = 0b00110001;  //6
	LDI  R30,LOW(49)
	OUT  0x18,R30
; 0000 00B4       PORTC = 0b00000100;  //0
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x0
; 0000 00B5       delay_ms(100);
; 0000 00B6       PORTA = 0b00000011;  //0
	LDI  R30,LOW(3)
	OUT  0x1B,R30
; 0000 00B7       PORTD = 0b00000011;  //0
	OUT  0x12,R30
; 0000 00B8       PORTB = 0b00101001;  //5
	LDI  R30,LOW(41)
	OUT  0x18,R30
; 0000 00B9       PORTC = 0b00000010;  //k
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x0
; 0000 00BA       delay_ms(100);
; 0000 00BB       PORTA = 0b01100100;  //3
	LDI  R30,LOW(100)
	OUT  0x1B,R30
; 0000 00BC       PORTD = 0b00011100;  //3
	LDI  R30,LOW(28)
	OUT  0x12,R30
; 0000 00BD       PORTB = 0b00100001;  //4
	LDI  R30,LOW(33)
	OUT  0x18,R30
; 0000 00BE       PORTC = 0b01001001;  //9
	LDI  R30,LOW(73)
	RCALL SUBOPT_0x0
; 0000 00BF       delay_ms(100);
; 0000 00C0       PORTA = 0b00100100;  //2
	LDI  R30,LOW(36)
	OUT  0x1B,R30
; 0000 00C1       PORTD = 0b00010100;  //2
	LDI  R30,LOW(20)
	OUT  0x12,R30
; 0000 00C2       PORTB = 0b00011001;  //3
	LDI  R30,LOW(25)
	OUT  0x18,R30
; 0000 00C3       PORTC = 0b00001001;  //8
	LDI  R30,LOW(9)
	RCALL SUBOPT_0x0
; 0000 00C4       delay_ms(100);
; 0000 00C5       PORTA = 0b01000100;  //1
	LDI  R30,LOW(68)
	OUT  0x1B,R30
; 0000 00C6       PORTD = 0b00001100;  //1
	LDI  R30,LOW(12)
	OUT  0x12,R30
; 0000 00C7       PORTB = 0b00010001;  //2
	LDI  R30,LOW(17)
	OUT  0x18,R30
; 0000 00C8       PORTC = 0b01110001;  //7
	LDI  R30,LOW(113)
	RCALL SUBOPT_0x0
; 0000 00C9       delay_ms(100);
; 0000 00CA       PORTA = 0b00000100;  //0
	LDI  R30,LOW(4)
	OUT  0x1B,R30
; 0000 00CB       PORTD = 0b00000100;  //0
	OUT  0x12,R30
; 0000 00CC       PORTB = 0b00001011;  //1
	LDI  R30,LOW(11)
	OUT  0x18,R30
; 0000 00CD       PORTC = 0b00110001;  //6
	LDI  R30,LOW(49)
	RCALL SUBOPT_0x0
; 0000 00CE       delay_ms(100);
; 0000 00CF       PORTA = 0b00000010;  //k
	LDI  R30,LOW(2)
	OUT  0x1B,R30
; 0000 00D0       PORTD = 0b00000010;  //k
	OUT  0x12,R30
; 0000 00D1       PORTB = 0b00000011;  //0
	LDI  R30,LOW(3)
	OUT  0x18,R30
; 0000 00D2       PORTC = 0b01010001;  //5
	LDI  R30,LOW(81)
	RCALL SUBOPT_0x0
